...
prompt_common_output = f"""
    ...
    3.  学園アイドルマスターに登場するアイドルが写っていた場合,特徴と最も一致するアイドルの名前をあげ，そのアイドルについて述べてください.髪型、顔立ち、目の色、髪の長さ、髪飾り、衣装、体格などを比較し、複数の特徴が一致するキャラクターを選択してください.判断材料となった身体的特徴については絶対に述べないでください.
